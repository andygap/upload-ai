...
import { Github, FileVideo, Upload, Sliders, Wand2 } from "lucide-react";
      ...
      <main className="flex-1 p-6 flex gap-6">
        <div className="flex flex-col flex-1 gap-4">
          <div className="grid grid-rows-2 gap-4 flex-1">
            ...
            <Textarea
              className="resize-none p-4 leading-relaxed"
              placeholder="Resultado da AI ..."
            />
          </div>
          <p className="text-sm text-muted-foreground">
            Lembre-se você pode usar a variavel{" "}
            <code> {"{transcription}"}</code> no seu prompt para adicionar o
            conteudo do video selecionado.
          </p>
        </div>
          ...
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <span className="block text-xs text-muted-foreground italic">
                Você poderá customizar essa opção e breve.
              </span>
            </div>

            <Separator />
            <div className="space-y-2">
              <Label>Teperatura</Label>
